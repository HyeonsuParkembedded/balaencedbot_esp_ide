...
[![Docs](https://img.shields.io/badge/Docs-Google%20Code%20Wiki-blue)]([https://code.google.com/p/your-wiki-url](https://codewiki.google/github.com/hyeonsuparkembedded/balaencedbot_esp_ide))
...
### 🛡️ **Professional Grade Features (2025.10.09)
- ✅ **High-Speed Telemetry**: 20Hz 바이너리 로깅 시스템으로 PID 제어 응답 정밀 분석 가능
- ✅ **Watchdog Timer (WDT)**: 하드웨어 WDT 적용으로 시스템 프리징 시 자동 복구 (2초 타임아웃)
- ✅ **Soft Start**: 모터 급가속 방지 로직으로 기어박스 보호 및 전류 스파이크 감소 (0.1초 램핑)
- ✅ **Voltage Compensation**: 배터리 전압 변동에 따른 PWM 듀티 자동 보정으로 일정한 제어 성능 유지
